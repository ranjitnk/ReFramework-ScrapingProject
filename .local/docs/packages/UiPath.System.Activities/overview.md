...
| [Multiple Assign](activities/MultipleAssign.md) | `MultipleAssign.md` | Assigns values to multiple variables in sequence. |
...
| Activity | File | Description |
|----------|------|-------------|
| [Create List](activities/CreateList.md) | `CreateList.md` | Creates a new empty list of a specified item type. |
| [Append Item to List](activities/AppendItemToList.md) | `AppendItemToList.md` | Appends one item to an existing list and returns the inserted index. |
...
| Activity | File | Description |
|----------|------|-------------|
| [Build Data Table](activities/BuildDataTable.md) | `BuildDataTable.md` | Creates a DataTable from the schema and rows configured in the designer. |
...
| [Modify Text](activities/ModifyText.md) | `ModifyText.md` | Applies one or more text modification operations to a source string. |
...
| [Get Next or Previous Date](activities/GetNextOrPreviousDate.md) | `GetNextOrPreviousDate.md` | Returns the next or previous date boundary relative to a source date. |
| [Modify Date](activities/ModifyDate.md) | `ModifyDate.md` | Applies one or more date modification operations to a source date. |
...
| [Delete File](activities/DeleteFileX.md) | `DeleteFileX.md` | Deletes a file at the specified path. **Windows only.** |
| [File Exists](activities/FileExistsX.md) | `FileExistsX.md` | Checks whether a file exists at the specified path. **Windows only.** |
| [Get File Info](activities/GetFileInfoX.md) | `GetFileInfoX.md` | Creates a FileInfo object for a specified file path. **Windows only.** |
| [For Each File in Folder](activities/ForEachFileX.md) | `ForEachFileX.md` | Iterates through files in a folder. **Windows only.** |
...
| [Move Folder](activities/MoveFolderX.md) | `MoveFolderX.md` | Moves a folder into another existing folder. **Windows only.** |
| [Rename Folder](activities/RenameFolderX.md) | `RenameFolderX.md` | Renames a folder without changing its parent folder. **Windows only.** |
| [Delete Folder](activities/DeleteFolderX.md) | `DeleteFolderX.md` | Deletes a folder at the specified path. **Windows only.** |
| [Folder Exists](activities/FolderExistsX.md) | `FolderExistsX.md` | Checks whether a folder exists at the specified path. **Windows only.** |
| [Get Folder Info](activities/GetFolderInfoX.md) | `GetFolderInfoX.md` | Creates a DirectoryInfo object for a specified folder path. **Windows only.** |
| [For Each Folder in Folder](activities/ForEachFolderX.md) | `ForEachFolderX.md` | Iterates through folders in a parent folder. **Windows only.** |
| [Get Local File or Folder](activities/PathExists.md) | `PathExists.md` | Opens a browse dialog to select a file or folder path. |
| [Select File](activities/SelectFile.md) | `SelectFile.md` | Opens a file picker dialog and returns the selected file path. **Windows only.** |
| [Select Folder](activities/SelectFolder.md) | `SelectFolder.md` | Opens a folder picker dialog and returns the selected folder path. **Windows only.** |
...
| [Input Dialog](activities/InputDialog.md) | `InputDialog.md` | Prompts the user for text, password input, or a selection. **Windows only.** |
| [Custom Input](activities/CustomInput.md) | `CustomInput.md` | Displays a custom HTML or web-based input form. **Windows only.** |
...
| [Invoke PowerShell](activities/InvokePowerShell.md) | `InvokePowerShell.md` | Runs a PowerShell command or script and returns pipeline output. **Windows only.** |
...
| [New Item Added to Queue](activities/QueueTrigger.md) | `QueueTrigger.md` | Trigger scope that fires when a new item is added to a queue. |
| [Trigger Scope](activities/TriggerScope.md) | `TriggerScope.md` | Runs an action when one of its contained triggers fires. |
| [File Change Trigger](activities/FileChangeTriggerV3.md) | `FileChangeTriggerV3.md` | Fires when a matching file system change is detected. **Windows only.** |
| [Process Start Trigger](activities/ProcessStartTriggerV2.md) | `ProcessStartTriggerV2.md` | Fires when a matching process starts. **Windows only.** |
| [Process End Trigger](activities/ProcessEndTriggerV2.md) | `ProcessEndTriggerV2.md` | Fires when a matching process ends. **Windows only.** |
| [Repeat Trigger](activities/RepeatTrigger.md) | `RepeatTrigger.md` | Fires repeatedly at the configured interval. |
| [Global Variable Changed Trigger](activities/GlobalVariableChangedTrigger.md) | `GlobalVariableChangedTrigger.md` | Fires when the selected global variable is notified as changed. |
| [Notify Global Variable Changed](activities/NotifyGlobalVariableChanged.md) | `NotifyGlobalVariableChanged.md` | Forces a change notification for a global variable. |
